  ...
  <div class="tab-content">
    ...
    <fieldset  >
								<legend></legend>
                                        ...
                                        <span class="action"><button class="g-button g-button-blue-linear" data-userauthority="1" type="button" onclick="t4show();">查询</button></sapn>
                                    <legend></legend>
							</fieldset>
							<div style="height: 10px;"></div>
							<div id="t4" style="display: none;">
							<p class="text-muted"><i></i>为您查询到&nbsp;<span style="color:#f70 ;font-weight: bold;font-size: 14px;">西安财经学院</span>符合<span style="color:#f70 ;font-weight: bold;font-size: 14px;">陕西-理科</span>&nbsp;条件的搜索结果如下</p>
