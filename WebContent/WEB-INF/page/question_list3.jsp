			...
			<div class="row">
				 ...
				 <div class="col-sm-9">
					...
					<div class="panel panel-warning">
					  ...
					  <div class="panel-body">
					    正如每个人有不同的指纹，每个人的人格也不一样，指纹无所谓好坏，性格也无所谓对错，这份试卷的目的是帮助你了解自己的性格类型，并找出与他人相异的地方，而与心理健康或心理困惑无关。下列每个问题都是以成对（A与B）的成对方式出现，A与B各自代表你所具或不具的一种特指，请根据你的实际情况来确定你的偏好程度，即给予每题的A与B各评定0到5分的分数。0表示你从未有这种情形（也就是另一项总是发生），5表示你总是有这样的情形（也就是另一项不发生）。
					 <p> <a href="#" class="btn btn-xs btn-warning pull-right" disabled="true" data-toggle="modal" data-target="#myModal">进入答题环节>></a></p>
					  </div>
					</div>
					<div class="panel panel-success">
					 ...
					 <p> <a href="#" class="btn btn-xs btn-success pull-right" data-toggle="modal" data-target="#myModal">进入答题环节>></a></p>
					  </div>
					</div>
					<!--model开始-->
