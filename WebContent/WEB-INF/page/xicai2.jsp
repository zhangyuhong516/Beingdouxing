		...
		<script>
			...
			$(function(){
					var vv=	document.getElementById("vid");
					 	vv.ontimeupdate=function(){
			   		$("#cur").html(this.currentTime);
			   	};
...
<div class="panel ">
			...
			<div class="row">
				 ...
				 <div class="col-sm-9">
                   ...
                   <video width="900" height="400"  id="vid" controls="controls">
				  
  				<source src="../vod/movie2.mp4" type="video/mp4">
