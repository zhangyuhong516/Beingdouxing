...
public abstract class ServletBase extends HttpServlet
{
	 ...
	 * @return
	 */
	public Object getService(String key)//通过传进来的key从ServletContext中取对象
	{
		System.out.println("servlet--base------getservice");
		Object obj=null;
		ServletContext sc=this.getServletContext();
		System.out.println("sc:     "+sc);
		obj=sc.getAttribute(key);
	...
	//设置正确提示信息
	public void setMessage(HttpServletRequest req,String msg)
	{
